...
{
    public class PrimaryCuisineAndSecondaryCostBracketWithRatingGreaterThanThresholdStrategy : RestaurantRecommendationStrategy
    {
        private static readonly float rating = 4.5F;
